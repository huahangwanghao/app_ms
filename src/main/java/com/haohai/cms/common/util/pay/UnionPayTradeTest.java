...
import com.haohai.cms.common.util.pay.unionpay.UnionPayTrade;
import com.haohai.cms.common.util.pay.unionpay.sdk.SDKConfig;
...
public class UnionPayTradeTest {
    ...
    public static void main(String[] args) {
        UnionPayTradeTest unionPayTradeTest=new UnionPayTradeTest();
        unionPayTradeTest.loadSDK();
        unionPayTradeTest.testTokenOpen();
